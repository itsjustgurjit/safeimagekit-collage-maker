...
function downloader() {
    ...
    domtoimage.toPng(downloadavatar)
        .then(function (dataUrl) {
            ...
            link.href = dataUrl;
            link.download = `Safeimagekit-avatar-maker.${document.querySelector('#image-format').value}`
            link.click();
        })
...
$(document).ready(function () {
    ...
    $("body").delegate("#random-avatar", "click", function () {
        random();
    });
    ...
    // random();
    document.getElementById("download-button").addEventListener("click", downloader)
})
function random() {
