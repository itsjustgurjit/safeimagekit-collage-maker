...
let x_width
let y_height
if (type_dimesions === "inches") {
  x_width = getScript.dataset.x * 96
  y_height = getScript.dataset.y * 96
} else {
  x_width = getScript.dataset.x
  y_height = getScript.dataset.y
}
...
const showLoader = () => {
  ...
  document.querySelector('#loader').innerHTML =
    '<p id="loadingMessage" class="mt-2 text-dark"></p>'
