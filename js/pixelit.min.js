  ...
  return (
    _createClass(t, [
      ...
      },
      {
        key: 'saveImage',
        value: function () {
          let fileDownloadType = document.querySelector('#image-format').value
          var t = document.createElement('a')
          ;(t.download = `safeimagekit-pixel-art.${fileDownloadType}`),
            (t.href = this.drawto
              .toDataURL(`image/${fileDownloadType}`)
              .replace(`image/${fileDownloadType}`, 'image/octet-stream')),
